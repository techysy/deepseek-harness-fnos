...
当前版本：**0.1.0-rc.6**（含 ARM/x86 离线包 + 在线通用包）

| 文件 | 架构 | 类型 | 说明 |
|------|------|------|------|
| `dsh-0.1.0-rc.6-all.fpk` | 通用 | url | 在线版，新标签页打开，x86/ARM 通用 |
| `dsh-0.1.0-rc.6-iframe-all.fpk` | 通用 | iframe | 在线版，桌面窗口内打开 |
| `dsh-0.1.0-rc.6-x86.fpk` | x86 | url | 离线版（含 x86 原生模块），新标签页打开 |
| `dsh-0.1.0-rc.6-iframe-x86.fpk` | x86 | iframe | 离线版（含 x86 原生模块），桌面窗口内打开 |
