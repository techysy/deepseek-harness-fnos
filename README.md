...
[![dsh](https://img.shields.io/badge/dsh-0.1.2--rc.2-blueviolet.svg)](https://github.com/deepseek-ai/deepseek-harness)
...
当前版本：**0.1.2-rc.2**（x86 离线包）

| 文件 | 架构 | 类型 | 说明 |
|------|------|------|------|
| `dsh-0.1.2-rc.2-x86.fpk` | x86 | url | 离线版（含 x86 原生模块），新标签页打开 |
| `dsh-0.1.2-rc.2-iframe-x86.fpk` | x86 | iframe | 离线版（含 x86 原生模块），桌面窗口内打开 |
